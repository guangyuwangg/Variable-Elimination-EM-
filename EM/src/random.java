...
//		System.out.println(Psyndrome.get(0));
//		System.out.println(Psyndrome.get(1));
//		System.out.println(Psyndrome.get(2));
//		
...
//			Psyndrome.set(i, Psyndrome.get(i) + randomValue);
...
//		}
//		
//		TRIMONO = (TRIMONO+randomValue)/ (randomValue * 2 + 1);
//		
//		total = 0;
//		for (int i = 0; i < 6; i++) {
//			total = total + PSloepnea.get(i).get(2)+randomValue;
//		}
//		for (int i = 0; i < 6; i++) {
//			PSloepnea.get(i).set(2, (PSloepnea.get(i).get(2)+randomValue)/total);
//		}
//		
//		total = 0;
//		for (int i = 0; i < 3; i++) {
//			total = total + PForiennditis.get(i).get(1)+randomValue;
//		}
//		for (int i = 0; i < 3; i++) {
//			PForiennditis.get(i).set(1, (PForiennditis.get(i).get(1)+randomValue)/total);
//		}
//		
//		total = 0;
//		for (int i = 0; i < 3; i++) {
//			total = total + PDegar.get(i).get(1)+randomValue;
//		}
//		for (int i = 0; i < 3; i++) {
//			PDegar.get(i).set(1, (PDegar.get(i).get(1)+randomValue)/total);
//		}
//		
//	}
//	
...
//		tmp = new Vector<Double>();
//		tmp.add(new Double(1.0));	//DS=a
//		tmp.add(new Double(0.40));	//P(F|DS)
//		PDegar.add(tmp);
//		tmp = new Vector<Double>();
//		tmp.add(new Double(2.0));	//DS=a
//		tmp.add(new Double(0.80));	//P(F|DS)
...
//		
////		for (int i = 0; i < Psyndrome.size(); i++) {
////			System.out.print(Psyndrome.get(i)+" ");
////		}
////		System.out.print("\n");
//		
//		
